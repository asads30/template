      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/pie-charts/simple-pie-chart/"
              target="_blank"
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/pie-charts/simple-donut/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/pie-charts/update-donut/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/pie-charts/monochrome-pie/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/pie-charts/gradient-donut/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/pie-charts/donut-with-pattern/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/pie-charts/pie-with-image/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
