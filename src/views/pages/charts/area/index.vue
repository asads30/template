      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/area-charts/basic/"
              target="_blank"
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/area-charts/spline/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/area-charts/datetime-x-axis/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/area-charts/negative/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/area-charts/github-style/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/area-charts/stacked/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/area-charts/irregular-timeseries/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/area-charts/chart-with-missing-data-or-null-values/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
