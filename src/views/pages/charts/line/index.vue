...
export default {
  ...
  data() {
    return {
      ...
      syncingLineChart: syncingLineChart,
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/line-charts/zoomable-timeseries/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/line-charts/data-labels/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/line-charts/dashed/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/line-charts/line-chart-annotations/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/line-charts/syncing-charts/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
          ...
          <div class="card-body">
            <div class="apex-charts">
              <apexchart
                ...
                :options="syncingLineChart.chartOptions"
              ></apexchart>
              ...
              <apexchart
                ...
                height="160"
                dir="ltr"
                :series="syncingAreaChart.series"
                :options="syncingAreaChart.chartOptions"
              ></apexchart>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/line-charts/brush-chart/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/line-charts/stepline/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/line-charts/gradient/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          >
            ...
            <a
              href="https://apexcharts.com/vue-chart-demos/line-charts/null-values/"
              target="_blank"
              class="btn btn-sm btn-soft-secondary"
              >Docs <i class="mdi mdi-arrow-right align-middle"></i
            ></a>
