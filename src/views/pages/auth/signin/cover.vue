                        ...
                        <div class="col-lg-10">
                            <div class="py-5">
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <router-link to="/auth/resetpassword-cover" class="text-white-50 text-decoration-underline">Forgot your password?</router-link>
                                                        </div>
                                                    </form><!-- end form -->
                                                </div>
                                            </div>
                                ...
                                <div class="mt-5 text-center text-muted">
                                    <p>Don't have an account ? <router-link to="/auth/signup-cover" class="fw-medium text-decoration-underline"> Signup </router-link></p>
                                </div>
                            </div>
                        </div><!-- end col -->
                    </div><!-- end row -->
